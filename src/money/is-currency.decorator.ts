...
// Self-contained validator for {currency, value} payloads — inlines all checks (not @ValidateNested) to dodge class-validator MetadataStorage duplication across api-sdk and consumers.
